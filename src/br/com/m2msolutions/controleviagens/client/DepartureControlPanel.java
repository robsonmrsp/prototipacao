...
public class DepartureControlPanel extends LayoutContainer {
	...
	private void initComponents() {
		...
		add(getPrincipalContainer(), new RowData(Style.DEFAULT, 240.0, new Margins()));
	}
...
//			principalContainer.setStyleName("main-style");
	...
	private LayoutContainer getHeaderContainerGridA() {
		if (headerContainerGridA == null) {
			...
			headerContainerGridA.setLayout(new AbsoluteLayout());
			headerContainerGridA.add(getPontoAHtml(), new AbsoluteData(0, 6));
		}
	...
	private LayoutContainer getHeaderContainerGridB() {
		if (headerContainerGridB == null) {
			...
			headerContainerGridB.setLayout(new AbsoluteLayout());
			headerContainerGridB.add(getPontoBHtml(), new AbsoluteData(6, 6));
			headerContainerGridB.add(getTools(), new AbsoluteData(196, 4));
		}
	...
	private WidgetDepartureControlRow getWidgetDepartureControlRow_3() {
		if (widgetDepartureControlRow_3 == null) {
			...
			widgetDepartureControlRow_3.setContent(new DTOArrivedControl("09:00", "09:01", "33346", "05", "09:01", "09:01", "87564", "05"), Chronology.PAST);
		}
	...
	private WidgetDepartureControlRow getWidgetDepartureControlRow_4() {
		if (widgetDepartureControlRow_4 == null) {
			...
			widgetDepartureControlRow_4.setContent(new DTOArrivedControl("09:45", "", "", "05", "09:45", "", "", "05"), Chronology.PRESENT);
		}
	...
	private WidgetDepartureControlRow getWidgetDepartureControlRow_8() {
		if (widgetDepartureControlRow_8 == null) {
			...
			widgetDepartureControlRow_8.setContent(new DTOArrivedControl("11:25", "", "", "04", "11:30", "", "", "02"), Chronology.FUTURE);
		}
	...
	private Image getTools() {
		if (tools == null) {
			tools = new Image("http://cdn1.iconfinder.com/data/icons/basicset/gear_16.png");
			tools.setSize("16px", "16px");
		}
		return tools;
	}
}
